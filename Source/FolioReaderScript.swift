...
//    }
    ...
    static let bridgeJS: FolioReaderScript = {
        ...
        return FolioReaderScript(source: jsSource, injectionTime: .atDocumentEnd, forMainFrameOnly: true)
    }()
    ...
    static let cssInjection: FolioReaderScript = {
        ...
        return FolioReaderScript(source: cssInjectionSource(for: cssString), injectionTime: .atDocumentEnd, forMainFrameOnly: true)
    }()
